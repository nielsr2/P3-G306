    ...
    for photo in photoArray:
        for face in photo.faces:
            for eye in face.eyes:
                ...
                compare(thresh1, eye.testMask)

def compare(manMask, machineMask):
    inputImg1 = manMask
    inputImg2 = machineMask
    ret,binary1 = cv2.threshold(manMask,127,255,cv2.THRESH_BINARY)
    ret,binary2 = cv2.threshold(machineMask,127,255,cv2.THRESH_BINARY)
    # m3Show.imshow(binary1, "binary1")
    rows1, cols1 = binary1.shape
